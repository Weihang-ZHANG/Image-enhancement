...
image_files = dir(fullfile('C:/Users/61071/Desktop/tu/*', '*.png'));
...
for i = 1:length(image_files)
    ...
    % scene segmentation
    extractor = ROIExtractor('approach1', 3);
    ...
    tmp=strsplit(image_files(i).name, '.');
    folder=strsplit(image_files(i).folder, 'tu');
    imwrite(fused_image, fullfile([folder{1},'tu1',folder{2}], [tmp{1}, '_fused.png']))
end
